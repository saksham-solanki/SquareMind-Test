  ...
  return (
    <div className="bg-cream rounded-[28px] p-11 max-lg:p-8 sticky top-[104px]">
      ...
      <form onSubmit={handleSubmit}>
        <FormField label="Full Name" type="text" placeholder="Amit Patel" required />
        <FormField label="Email" type="email" placeholder="amit@company.com" required />
        ...
        <div className="mb-4">
          ...
          <select className="w-full px-[18px] py-3.5 border-[1.5px] border-gray-300 rounded-[12px] text-[15px] bg-white text-ink focus:outline-none focus:border-ink transition-all tracking-[-0.01em]">
        ...
        <div className="mb-4">
          ...
          <textarea placeholder="e.g. Considering a flat in Bangalore, need help evaluating..." className="w-full px-[18px] py-3.5 border-[1.5px] border-gray-300 rounded-[12px] text-[15px] bg-white text-ink focus:outline-none focus:border-ink transition-all tracking-[-0.01em] resize-y min-h-[90px]" />
        </div>
...
function FormField({ label, type, placeholder, required }: { label: string; type: string; placeholder: string; required?: boolean }) {
  return (
    <div className="mb-4">
      ...
      <input type={type} placeholder={placeholder} required={required} className="w-full px-[18px] py-3.5 border-[1.5px] border-gray-300 rounded-[12px] text-[15px] bg-white text-ink focus:outline-none focus:border-ink focus:shadow-[0_0_0_3px_rgba(10,10,10,0.06)] transition-all tracking-[-0.01em]" />
    </div>
  );
}
